...
The current goal of this project is to help streamers with similar problems to make their streams more interactive, engaging and unique.
...
- <img src="https://cdn.frankerfacez.com/emoticon/145916/1" width="20" height="20"> **Use the same captions source on multiple clients simultaneously** - only web version
...
- <img src=".github/images/browsers/chrome.png" height=20><img src=".github/images/browsers/edge.png" height=20> [Browser native](https://caniuse.com/speech-recognition) - utilizes browser integrated api. (MS Edge quality is similar to Azure, but free, btw). Not available in standalone version
